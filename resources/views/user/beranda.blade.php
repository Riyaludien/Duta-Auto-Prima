...
<section class="hero-section">
    <div id="heroCarousel" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <!-- SLIDE 1 -->
            <div class="carousel-item active">
                <div class="hero-slide" style="background: linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url('{{ asset('images/banner-1.jpg') }}') center/cover no-repeat;">
                    <div class="container-fluid px-5">
                        <h1 class="hero-title">Nikmati hematnya servis kendaraan!</h1>
                        <p class="fs-5">Jelajahi promo dari bengkel terdekat</p>
                    </div>
            ...
            <!-- SLIDE 2 -->
            <div class="carousel-item">
                <<div class="hero-slide" style="background: linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url('{{ asset('images/banner-2.jpg') }}') center/cover no-repeat;">
                    <div class="container-fluid px-5">
                        <h1 class="hero-title">Booking servis tanpa ribet</h1>
                        <p class="fs-5">Langsung dari HP kamu 🚀</p>
                    </div>
        ...
        <!-- SLIDE 3 -->
        <div class="carousel-item">
            <div class="hero-slide" style="background: linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url('{{ asset('images/banner-3.jpg') }}') center/cover no-repeat;">
                <div class="container-fluid px-5">
                    <h1 class="hero-title">Bengkel terpercaya</h1>
                    <p class="fs-5">Kualitas terjamin & profesional</p>
                </div>
