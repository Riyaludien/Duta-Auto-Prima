            ...
            <div class="col-lg-3 mb-4">
                <div class="filter-card p-4">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h5 class="fw-bold m-0" style="color: var(--text-main);"><i class="bi bi-funnel me-2"></i>FILTER
                        </h5>
                        {{-- Tombol Reset kecil di pojok kanan atas filter --}}
                        @if(request()->anyFilled(['kategori', 'min', 'max', 'search']))
                            <a href="/katalog" class="text-decoration-none small"
...
>>>>>>> 1c33b85b91dd56bd1fa1c80d1a28068736ebf1e7
                    ...
                    <form action="/katalog" method="GET">
                            ...
                            @foreach ($kategoris as $kategori)
                                <div class="form-check mb-2">
                                    <input class="form-check-input" type="radio" name="kategori" value="{{ $kategori->id }}"
                                        id="cat_{{ $kategori->id }}" {{ request('kategori') == $kategori->id ? 'checked' : '' }}>
                                    <label class="form-check-label small text-muted" for="cat_{{ $kategori->id }}">
                                        {{ $kategori->nama_kategori }}
                                    </label>
                                </div>
                        ...
                        <div class="d-grid gap-2">
                            ...
                            {{-- Tombol Reset sebagai outline di bawah tombol terapkan --}}
                            <a href="/katalog " class="btn btn-sm rounded-pill fw-bold btn-outline-secondary"
                                style="font-size: 0.75rem; border-color: var(--border-dark); color: var(--text-muted);">
                                BATALKAN FILTER
                            </a>
                        </div>
<<<<<<< HEAD
